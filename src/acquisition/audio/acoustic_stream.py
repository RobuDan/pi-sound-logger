...
from acquisition.help_functions.average import calculate_laeq
...
class AcousticStream:
    ...
    def wait_for_next_second(self) -> float:
        ...
        """
        return self.timestamp_provider.delay_until_next_second()
    ...
    async def _run_loop(self):
        ...
        try:
            ...
            last_cycle_start = self.timestamp_provider.current_second()
            ...
            while self.run_flag:
                ...
                try:
                    log_time = base_time.isoformat(timespec="milliseconds")
                    timestamp = self.timestamp_provider.to_mysql_timestamp(base_time)  # For MySQL
